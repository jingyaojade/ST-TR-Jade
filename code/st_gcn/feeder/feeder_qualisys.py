...
from .qualisys_read_skeleton import read_xyz
# visualization
import time
...
class Feeder_qualisys(torch.utils.data.Dataset):
...
if __name__ == '__main__':
    data_path = "../data/qualisys/xsub/val_data_joint_bones.npy"
    label_path = "../data/qualisys/xsub/val_label.pkl"
